...
# label\predict:          0,      1,      2,
# 0,                 0.9577, 0.0417, 0.0006
# 1,                 0.1420, 0.8554, 0.0026
# 2,                 0.1407, 0.8479, 0.0025
# Validate:
# label\predict:            0,      1,      2,
# 0,                   0.9248, 0.0689, 0.0058
# 1,                   0.3831, 0.5344, 0.0727
# 2,                   0.3591, 0.5427, 0.0682
...
# label\predict:          0,      1,      2,
# 0,                 0.8719, 0.1247, 0.0031
# 1,                 0.1242, 0.8676, 0.0079
# 2,                 0.1231, 0.8600, 0.0078
# Validate:
# label\predict:            0,      1,      2,
# 0,                   0.8656, 0.1280, 0.0053
# 1,                   0.2607, 0.6712, 0.0545
# 2,                   0.2653, 0.6709, 0.0511