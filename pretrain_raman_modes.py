...
from dataset import StructureFmtEnDataset,StructureRamanModesDataset
...
train_set = torch.load("./materials/mp/Train_raman_modes_set.pt")
validate_set = torch.load("./materials/mp/Valid_raman_modes_set.pt")
